...
if [ "$WEB_UPGRADE" = false ]; then
  ...
  if ! [ -t 0  ]; then
    echo -e "Detected old installation command. Please use:\n$ bash <(curl -sL https://raw.githubusercontent.com/MattRMorgan/Anthias-MSU-Denver-Bulletin-Board-MM/master/bin/install.sh)"
    exit 1
  fi
 ...
 ........     ...:X$$$$X;..X....                                                                                      
   ...
   .....$+..xXXXXXXXXXXxX+XXXXXXX+:.............+XxX$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$x..                                                         
    ...
    ...         .                                 .....x..                                                                                      
   .xXX:.    ..XXx.. ........    .   .   ... .    ........  . ....       ... ....          .. .. . .. ........     ....     .                   
   ..XXX.   ..xXX...;XXXXXx.+XXXXXXXx.;XXXXx:......xXxXX:....+XXXX+......xXxXx.....XX+.....xXx.:XXXXXXXX....+.....+XX.....Xx...                 
   ..X.XX....+:XX....XX.........X;.....XX...XX...XX.....;X:. .Xx...Xx..Xx.....+X...+X.......X......Xx......XX:.....xXX;...+....                 
   ..X..XX..:+.XX....XX::+..   .X;.....XX..;X:..xX... ...XX...Xx..:X:.XX.   ...XX..+X.......X......Xx. ...X.;X.....x.:XX..+....                 
   ..X..:Xx.X..XX....XX....    .X;.....XX.+X:...+X.......XX...Xx......XX.    ..XX..+X.......X......Xx....++xxXX....x...XXx+....                 
   ..X...+XX...XX....XX.........X;.   .XX..:Xx...XX.....+X....Xx..   ..XX.....XX...+X....+..X......Xx...::....XX...x.....XX..                   
    ;;;...X...;:::..:::::::....:;;..  :;;:. .:;:...:+xx;.....:;;:..  ....:xxx:. ...;;:::::.;:;....:::...::....;;;.;;:.....+..                   
    ...............................   ..... .....................    ...................................    ...................                 
   ..$...;.......................................+$:......$$.....    ...................................    ................................... 
...
if [ -z "${REPOSITORY}" ]; then
  if [ "$WEB_UPGRADE" = false ]; then
    set -x
    REPOSITORY=${1:-https://github.com/MSU-Denver-Bulletin-Board/Anthias-MSU-Denver-Bulletin-Board.git}
  else
    set -e
    REPOSITORY=https://github.com/MSU-Denver-Bulletin-Board/Anthias-MSU-Denver-Bulletin-Board.git
  fi
fi
...
if [ "$BRANCH" = "master" ]; then
    ANSIBLE_VERSION=$(curl -s https://raw.githubusercontent.com/MSU-Denver-Bulletin-Board/Anthias-MSU-Denver-Bulletin-Board/$BRANCH/requirements/requirements.host.txt | grep ansible)
else
